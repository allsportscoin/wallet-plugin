...
function mapDispatchToProps (dispatch) {
	return {
		...
		setAccountLabel: (account, label, snsName) => {
			dispatch(actions.setAccountLabel(account, label, snsName));
		},
	};
}
...
EditAccountNameModal.prototype.render = function () {
	...
	return h('div', {}, [
		h('div.flex-column.edit-account-name-modal-content', {}, [
			...
			h('div.edit-account-name-modal-title', {}, [this.context.t('editAccountName')]),
